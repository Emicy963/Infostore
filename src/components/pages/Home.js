...
const Home = () => {
  ...
  const promoBanners = [
    {
      image:
        "https://images.unsplash.com/photo-1593642632823-8f785ba67e45?w=1200&h=400&fit=crop",
    ...
    {
      image:
        "https://images.unsplash.com/photo-1547082299-de196ea013d6?w=1200&h=400&fit=crop",
    ...
    {
      image:
        "https://images.unsplash.com/photo-1587614387466-0a72ca909e16?w=1200&h=400&fit=crop",
  ...
  useEffect(() => {
    ...
    const fetchCategories = async () => {
      try {
        ...
        setCategories(
          Array.isArray(categoriesData) ? categoriesData : sampleCategories
        );
      } catch (error) {
  ...
  return (
    ...
    >
      ...
      <div
        ...
        } border-b shadow-sm sticky top-16 z-40`}
      >
      ...
      <section
        className={`${
          darkMode ? "bg-gray-800" : "bg-gradient-to-r from-blue-50 to-blue-100"
        } py-8`}
      >
                ...
                <div key={index} className="min-w-full relative">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-r from-black/70 via-black/50 to-transparent flex items-center">
                    <div className="text-white px-8 md:px-16 max-w-2xl">
                      ...
                      <p
                        className="text-lg md:text-xl mb-6 animate-fade-in-up"
                        style={{ animationDelay: "0.2s" }}
                      >
                        {banner.subtitle}
                      </p>
                      <button
                        className="bg-yellow-400 text-gray-900 px-8 py-3 rounded-lg font-semibold hover:bg-yellow-300 transition-all duration-300 hover:scale-105 shadow-lg animate-fade-in-up"
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              <div
                key={index}
                className={`flex items-center gap-3 p-4 ${feature.bg} rounded-lg`}
              >
                <div
                  className={`bg-${feature.color}-600 text-white p-3 rounded-full`}
                >
