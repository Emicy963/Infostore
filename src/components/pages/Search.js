  ...
  return (
    <div className="pt-16 pb-12 bg-gray-50 min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-12">
          <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Buscar <span className="text-primary">Produtos</span></h1>
          ...
          <form onSubmit={handleSubmit} className="max-w-2xl mx-auto">
            <div className="flex">
              ...
              <button
                type="submit"
                className="bg-primary text-white px-6 py-3 rounded-r-lg font-semibold hover:bg-primary-dark transition-colors"
              >
                Buscar
              </button>
            </div>
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-lg shadow-lg p-12 text-center">
            <h2 className="text-2xl font-semibold mb-4">Buscar Produtos</h2>
            <p className="text-gray-600 mb-6">
              Digite o nome do produto que você está procurando no campo acima.
            </p>
            <div className="max-w-md mx-auto">
              <h3 className="text-lg font-medium mb-3">Sugestões de busca:</h3>
